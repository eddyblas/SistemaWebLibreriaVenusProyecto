        ...
        "columns": [
            ...
            { "data": "descripcion" },
            {
                "data": "esActivo", render: function (data) {
                    if (data == 1)
                        return '<span class="badge-info">Activo</span>'
                    else
...
$("#btnGuardar").click(function () {
    if ($("#txtDescripcion").val().trim() == "") {
        toastr.warning("", "Debe completar el campo: descipcion")
        ...
        fetch("/Categoria/Editar", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "L Categoria ha sido Modificada", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
