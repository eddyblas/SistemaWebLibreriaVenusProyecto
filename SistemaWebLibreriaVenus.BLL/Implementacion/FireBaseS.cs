...
{
    public class FireBaseS : IFireBaseS
    {
        private readonly IGenericRepository<Configuracion> _repositorio;

        public FireBaseS(IGenericRepository<Configuracion> repositorio)
        {
        ...
        public async Task<string> SubirStorage(Stream StreamArchivo, string CarpetaDestino, string NombreArchivo)
        {
            ...
            try
            {
                ...
                var aut = await auth.SignInWithEmailAndPasswordAsync(Config["email"], Config["clave"]);
                ...
                var task = new FirebaseStorage(
                    ...
                    {
                        AuthTokenAsyncFactory = () => Task.FromResult(aut.FirebaseToken),
                        ThrowOnCancel = true
                    })
